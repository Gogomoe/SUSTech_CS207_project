...
set_property PACKAGE_PIN L5 [get_ports {bt[7]}]
set_property PACKAGE_PIN J6 [get_ports {bt[6]}]
set_property PACKAGE_PIN K6 [get_ports {bt[5]}]
set_property PACKAGE_PIN M2 [get_ports {bt[4]}]
set_property PACKAGE_PIN K3 [get_ports {bt[3]}]
set_property PACKAGE_PIN L3 [get_ports {bt[2]}]
set_property PACKAGE_PIN J4 [get_ports {bt[1]}]
set_property PACKAGE_PIN K4 [get_ports {bt[0]}]
set_property IOSTANDARD LVCMOS15 [get_ports {bt[7]}]
set_property IOSTANDARD LVCMOS15 [get_ports {bt[6]}]
set_property IOSTANDARD LVCMOS15 [get_ports {bt[5]}]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sw_IBUF[23]]